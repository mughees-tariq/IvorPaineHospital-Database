...
(23, 'Standard', 1, 'Ward F'), (24, 'Standard', 1, 'Ward F'),
...
(31, 'Pediatric', 1, 'Ward E'),(32, 'Oncology',  1, 'Ward F');
GO
...
(316, 'Parveen Akhtar', '1985-05-20', '5 I-6, Islamabad', 13, NULL, '2025-03-05', 24, 210, 210),
(317, 'Qasim Mir', '1970-11-12', '22 F-7, Islamabad', 14, NULL, '2025-03-08', 28, 207, 207),
(318, 'Razia Begum', '1950-04-04', '37 G-9, Islamabad', 15, NULL, '2025-03-10', 29, 208, 208),
...
(325, 'Yousaf Ranjha', '1958-05-05', '25 G-7, Islamabad', 1, NULL, '2025-03-22', 4, 201, 201),
(326, 'Zainab Toor', '1991-01-14', '36 I-10, Islamabad', 3, NULL, '2025-03-24', 8, 204, 208),
(327, 'Arif Sultan', '1976-07-07', '47 F-10, Islamabad', 5, NULL, '2025-03-26', 11, 202, 202),
(328, 'Bashir Ahmad', '1967-03-21', '58 G-8, Islamabad', 7, NULL, '2025-03-28', 16, 203, 209),
(329, 'Cyrus Khan', '2012-11-09', '69 I-7, Islamabad', 9, NULL, '2025-03-30', 31, 205, 205),
(330, 'Diana Gul', '1982-08-31', '80 F-9, Islamabad', 11, NULL, '2025-04-01', 32, 206, 210);
GO
...
-- New non-consultant doctors
INSERT INTO Doctor (DoctorNo, DoctorName, Address, DateOfBirth) VALUES
(211, 'Dr. Kamil Baig',   '10 F-7, Islamabad',  '1995-03-12'),
(212, 'Dr. Laila Sethi',  '22 G-9, Islamabad',  '1996-07-18'),
(213, 'Dr. Mansoor Ali',  '35 I-8, Islamabad',  '1994-11-05'),
(214, 'Dr. Nadia Aziz',   '48 F-10, Islamabad', '1997-02-28'),
(215, 'Dr. Omar Farooqi', '61 G-6, Islamabad',  '1993-09-14');
GO

--  JH to existing consultant teams
INSERT INTO DoctorTeamRecord (DoctorNo, DateJoined, EndDate, PositionCode, ConsultantNo) VALUES
(211, '2024-01-01', NULL, 2, 201),
(212, '2024-01-01', NULL, 2, 202),
(213, '2024-01-01', NULL, 2, 203),
(214, '2024-02-01', NULL, 2, 204),
(215, '2024-02-01', NULL, 2, 205);
GO

-- Assign these JH doctors as DoctorInCharge for some patients
UPDATE Patient SET DoctorInChargeNo = 211 WHERE PatientNo = 319;
UPDATE Patient SET DoctorInChargeNo = 212 WHERE PatientNo = 320;
UPDATE Patient SET DoctorInChargeNo = 213 WHERE PatientNo = 324;
GO

-- Match TreatmentRecord treating doctor
UPDATE TreatmentRecord SET DoctorNo = 211 WHERE PatientNo = 319 AND DoctorNo = 202;
UPDATE TreatmentRecord SET DoctorNo = 212 WHERE PatientNo = 320 AND DoctorNo = 203;
UPDATE TreatmentRecord SET DoctorNo = 213 WHERE PatientNo = 324 AND DoctorNo = 204;
GO
